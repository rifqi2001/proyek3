    ...
    <div class="w-full container mx-auto flex flex-wrap items-center justify-between mt-0 py-2">
      ...
      <div class="w-full flex-grow lg:flex lg:items-center lg:w-auto hidden mt-2 lg:mt-0 bg-gray lg:bg-transparent text-black p-4 lg:p-0 z-20" id="nav-content">
        <ul class="list-reset lg:flex justify-end flex-1 items-center">
          <li class="mr-3">
            <a class="toggleColour inline-block py-2 px-4 text-white font-bold no-underline" href="#">Beranda</a>
          </li>
          <li class="mr-3">
            <a class="toggleColour inline-block text-white no-underline hover:text-gray-800 hover:text-underline py-2 px-4" href="#">Produk</a>
          </li>
          <li class="mr-3">
            <a class="toggleColour inline-block text-white no-underline hover:text-gray-800 hover:text-underline py-2 px-4" href="#">Bantuan</a>
          </li>
        </ul>
