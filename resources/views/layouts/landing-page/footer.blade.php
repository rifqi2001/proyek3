<footer class="bg-white">
  <div class="container mx-auto px-8">
    <div class="w-full flex flex-col md:flex-row py-6">
      <div class="flex-1 mb-6 text-grey">
        <a class="w-full my-2 text-4xl font-bold leading-tight text-center text-gray-800" href="#">
      ...
      <div class="flex-1">
        ...
        <ul class="list-reset mb-6">
          <li class="mt-2 inline-block mr-2 md:block md:mr-0">
            <a href="https://www.instagram.com/agpendingin_official02/" class="no-underline hover:underline text-gray-800 hover:text-blue-500">Instagram</a>
          </li>
          <li class="mt-2 inline-block mr-2 md:block md:mr-0">
      ...
      <div class="flex-1" >
        ...
        <ul class="list-reset mb-6">
          ...
          <li class="mt-2 inline-block mr-2 md:block md:mr-0">
            <a href="https://wa.me/6285864639808" class="no-underline hover:underline text-gray-800 hover:text-blue-500">WhatsApp</a>
          </li>
        </ul>
